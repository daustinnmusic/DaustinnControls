using DaustinnControls.DaustinnControls;
using DaustinnControls.Testing;
...
namespace DaustinnControls
{
    public partial class Form1 : Form
    {
        ...
        private void Open_DropdownMenu(DaustinnDropdownMenu dropdownMenu, object sender)
        {
        ...
        private void Open_DropdownMenu2(DaustinnDropdownMenu dropdownMenu, object sender)
        {
            Control control = (Control)sender;
            dropdownMenu.VisibleChanged += new EventHandler((sender2, ev)
              => DropdownMenu_VisibleChanged(sender2, ev, control));
        ...
        {
            DaustinnDropdownMenu dropdownMenu = (DaustinnDropdownMenu)sender;
            if (!DesignMode)
            {
