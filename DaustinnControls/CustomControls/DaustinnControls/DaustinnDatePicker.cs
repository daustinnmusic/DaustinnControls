...
namespace DaustinnControls.DaustinnControls
{
    public class DaustinnDatePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = DaustinnControlsAdvance.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = DaustinnControlsAdvance.Properties.Resources.calendarDark;
                else calendarIcon = DaustinnControlsAdvance.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
